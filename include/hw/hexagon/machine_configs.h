...
hexagon_config_table v75na_1024_cfgtable = {
    .l2tcm_base =            0xd8000000,
    .reserved =              0x00000000,
    .subsystem_base =        0x00002000,
    .etm_base =              0xd8190000,
    .l2cfg_base =            0xd81a0000,
    .reserved2 =             0x00000000,
    .l1s0_base =             0xd9000000,
    .axi2_lowaddr =          0x00003000,
    .streamer_base =         0x00000000,
    .clade_base =            0x00000000,
    .fastl2vic_base =        0xd81e0000,
    .jtlb_size_entries =     0x00000080,
    .coproc_present =        0x00000001,
    .ext_contexts =          0x00000004,
    ...
    .tiny_core =             0x00000000,
    .l2itcm_size =           0x00000000,
    .l2itcm_base =           0xd8000000,
    .clade2_base =           0x00000000,
    .dtm_present =           0x00000000,
    .dma_version =           0x00000004,
    .hvx_vec_log_length =    0x00000007,
    .core_id =               0x00000000,
    .core_count =            0x00000000,
    .hmx_int8_spatial =      0x00000040,
    .hmx_int8_depth =        0x00000020,
    .v2x_mode =              0x00000001,
    .hmx_int8_rate =         0x00000010,
    .hmx_fp16_spatial =      0x00000020,
    .hmx_fp16_depth =        0x00000020,
    .hmx_fp16_rate =         0x00000008,
    .hmx_fp16_acc_frac =     0x00000016,
    .hmx_fp16_acc_int =      0x00000008,
    .acd_preset =            0x00000001,
    .mnd_preset =            0x00000001,
    .l1d_size_kb =           0x00000010,
    .l1i_size_kb =           0x00000020,
...
hexagon_config_extensions v75na_1024_extensions = {
    .cfgbase =             0xd8180000,
    .cfgtable_size =       0x00000400,
    .l2tcm_size =          0x00000000,
    .l2vic_base =          0xfc910000,
...
hexagon_config_table SA8540P_cdsp0_cfgtable = {
...
hexagon_config_extensions SA8540P_cdsp0_extensions = {

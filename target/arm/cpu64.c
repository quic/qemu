...
static const ARMCPRegInfo cortex_a55_cp_reginfo[] = {
    { .name = "CPUACTLR_EL1", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 1, .crn = 15, .crm = 2, .opc2 = 0,
      .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
    { .name = "CPUACTLR",
...
static const ARMCPRegInfo cortex_a76_n1_cp_reginfo[] = {
#ifndef CONFIG_USER_ONLY
    { .name = "L2CTLR_EL1", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 1, .crn = 11, .crm = 0, .opc2 = 2,
      .access = PL1_RW, .readfn = a57_a53_l2ctlr_read,
...
static void aarch64_a55_initfn(Object *obj)
{
    ...
    cpu->isar.id_aa64pfr0 = 0x00112222;
    cpu->isar.id_aa64dfr0 = 0x10303408;
    cpu->isar.id_aa64isar0 = 0x10211140;
    cpu->isar.id_aa64mmfr0 = 0x00101122; /* 40 bit physical addr */
    cpu->isar.dbgdidr = 0x35184100;
    cpu->clidr = 0x0a200023;
    cpu->ccsidr[0] = 0x700fe01a; /* 32KB L1 dcache */
    cpu->ccsidr[1] = 0x201fe00a; /* 32KB L1 icache */
    cpu->ccsidr[2] = 0x707fe07a; /* 1024KB L2 cache */
    ...
    cpu->gic_vpribits = 5;
    cpu->gic_vprebits = 5;
    define_arm_cp_regs(cpu, cortex_a55_cp_reginfo);
}
...
static void aarch64_a76_initfn(Object *obj)
{
    ...
    cpu->gic_vpribits = 5;
    cpu->gic_vprebits = 5;
    define_arm_cp_regs(cpu, cortex_a76_n1_cp_reginfo);
}

static void aarch64_n1_initfn(Object *obj)
{
    ARMCPU *cpu = ARM_CPU(obj);
    ...
    cpu->isar.id_aa64mmfr1 = 0x10212122;
    cpu->isar.id_aa64mmfr2 = 0x0100000000001011;
    cpu->clidr = 0x08200023;
    cpu->ccsidr[0] = 0x701fe00a; /* 32KB L1 dcache */
    cpu->ccsidr[1] = 0x201fe012; /* 48KB L1 icache */
    cpu->ccsidr[2] = 0x707fe07a; /* 1MB L2 cache */
...
static const ARMCPUInfo aarch64_cpus[] = {
    ...
    { .name = "neoverse-n1",        .initfn = aarch64_n1_initfn },

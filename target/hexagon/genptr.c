...
void gen_store1i(TCGv_env cpu_env, TCGv v_addr, int32_t src, uint32_t slot)
{
    ...
    gen_store1(cpu_env, v_addr, tmp, slot);
}
...
void gen_store2i(TCGv_env cpu_env, TCGv v_addr, int32_t src, uint32_t slot)
{
    TCGv tmp = tcg_constant_tl(src);
    gen_store2(cpu_env, v_addr, tmp, slot);
}

void gen_store4(TCGv_env cpu_env, TCGv v_addr, TCGv src, uint32_t slot)
{
...
{
    TCGv tmp = tcg_constant_tl(src);
    gen_store4(cpu_env, v_addr, tmp, slot);
}
...
void gen_store8i(TCGv_env cpu_env, TCGv v_addr, int64_t src, uint32_t slot)
{
    ...
    gen_store8(cpu_env, v_addr, tmp, slot);
}

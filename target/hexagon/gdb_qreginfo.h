...
const char * const hexagon_qreg_descs[] = {
    ...
    "name:gpmucnt4;alt-name:;bitsize:32;offset=4736;variable-size:0;encoding:uint;format:hex;set:Guest Registers;dwarf:195;generic:;",
    "name:gpmucnt5;alt-name:;bitsize:32;offset=4740;variable-size:0;encoding:uint;format:hex;set:Guest Registers;dwarf:196;generic:;",
    "name:gpmucnt6;alt-name:;bitsize:32;offset=4744;variable-size:0;encoding:uint;format:hex;set:Guest Registers;dwarf:197;generic:;",
    "name:gpmucnt7;alt-name:;bitsize:32;offset=4748;variable-size:0;encoding:uint;format:hex;set:Guest Registers;dwarf:198;generic:;",
